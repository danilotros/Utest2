...
public class FillPersonalInformation implements Task {
    ...
    public FillPersonalInformation(List<UtestData> data) {
        this.data = data;
    }

    public static Performable inPagePersonalInformation(List<UtestData> data) {
        return Tasks.instrumented(FillPersonalInformation.class,data);
    }
